...
echo '<div><label>' . elgg_view('input/checkbox', [
...
foreach ($policy as $p) {
	...
	echo '<div class="elgg-col elgg-col-1of6">' . elgg_view('input/dropdown', [
